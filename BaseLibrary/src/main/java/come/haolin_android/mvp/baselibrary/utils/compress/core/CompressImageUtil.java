package come.haolin_android.mvp.baselibrary.utils.compress.core;
...
public class CompressImageUtil {
    ...
    private File getPhotoCacheDir(File file) {
        if (TextUtils.isEmpty(config.getCacheDir())) config.setCacheDir(ConstantObj.COMPRESS_CACHE);
        File mCacheDir = new File(ConstantObj.BASE_CACHE_PATH
