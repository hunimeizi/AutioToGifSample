package come.haolin_android.mvp.baselibrary.glideimageview;
...
import come.haolin_android.mvp.baselibrary.glideimageview.progress.OnProgressListener;
import come.haolin_android.mvp.baselibrary.glideimageview.transformation.CircleTransformation;
import come.haolin_android.mvp.baselibrary.glideimageview.transformation.RadiusTransformation;
...
public class GlideImageView extends ImageView {
    ...
    public GlideImageView thumbnail() {
        getImageLoader().getGlideRequest().thumbnail(0.1f);
        return this;
    }
    ...
    public void loadLoalCircleRect(@DrawableRes int resId, @DrawableRes int placeholder,int radius) {
        loadDrawableCircleRect(resId, placeholder, radius);
    }
    public void loadDrawableCircleRect(@DrawableRes int resId, @DrawableRes int placeholder,int radius) {
        getImageLoader().load(resId, placeholder, new RadiusTransformation(getContext(), radius));
    }
    @Override
