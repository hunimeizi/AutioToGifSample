...
import come.haolin_android.mvp.baselibrary.glideimageview.progress.GlideRequest;
import come.haolin_android.mvp.baselibrary.glideimageview.progress.OnProgressListener;
import come.haolin_android.mvp.baselibrary.glideimageview.progress.ProgressManager;
...
public class GlideImageLoader {
    ...
    protected GlideImageLoader loadImage(Object obj, @DrawableRes int placeholder, Transformation<Bitmap> transformation) {
        ...
        if (placeholder != 0) {
            glideRequest = (GlideRequest<Drawable>) glideRequest.placeholder(placeholder);
        }

        if (transformation != null) {
            glideRequest = (GlideRequest<Drawable>) glideRequest.transform(transformation);
        }
