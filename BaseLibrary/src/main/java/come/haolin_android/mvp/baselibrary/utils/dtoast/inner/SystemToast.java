...
import come.haolin_android.mvp.baselibrary.utils.dtoast.DUtil;
...
public class SystemToast implements IToast, Cloneable {
    ...
    private View assertContentViewNotNull() {
        if (contentView == null) {
            contentView = View.inflate(mContext, R.layout.common_mytoast_layout, null);
        }
        return contentView;
    }
     ...
     */
    private static void hookINotificationManager(Toast toast, Context mContext) {
