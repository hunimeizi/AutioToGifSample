...
public class DUtil {
    ...
    private static String getSystemProperty(String key, String defaultValue) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, IllegalArgumentException {
        try {
